function[]=Pick(motor3Obj,motor2Obj,motor1Obj,TouchUpobj,x,y,z)
...
while 1
    ...
    if  double(readRotation(motor3Obj)/3)<=rad2deg(theta3)
       break;
    end
end   
...
% To go to the upper position using touch sensor
motor2Obj.Speed = -30;
start(motor2Obj);
